...
import { Box, Typography, Badge, Fade, CardActions } from '@mui/material';
...
const Notification = () => {
  ...
  const CustomBadge: FC<ParentProps> = (props) => {
    return (
      <Badge
          ...
          <TabContext value={value}>
            ...
            </TabList>
            {
              notiInfo.map((rows, idx) => {
                return (
                  <TabPanel key={idx} value={rows.value} className={classes.tabPanelCustomStyle}>
                    {
                          ...
                          >
                            ...
                            <RowBox marginTop="41px" height="24px">
                              ...
                              <Box sx={{ float: 'right' }}>
                                ...
                                <ArrowRightIcon
                                  className={
                                    (subValue < rows.info.length - 1 && rows.info.length >= 1)
                                      ? classes.arrowActiveStyle
                                      : classes.arrowDeActiveStyle
                                  }
