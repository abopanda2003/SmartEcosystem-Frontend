  ...
  [
    {
      ...
      tooltip: 'Earn SMT by farming SMT. The higher your license, the more rewards could be earned. Farming more SMT can get you more rewards as well.',
      badge: '2',
      content: '1 / 365',
    ...
    },
    {
      ...
      tooltip: 'Golden Tree is grown by community contribution. The more phases of growth passed, the more surprise for loyal community!',
      badge: 'none',
  ...
  [
    {
      ...
      tooltip: 'Get SMT, SMTC, NFTs or other Partner tokens by joining future Airdrops!',
      badge: 'none',
    ...
    {
      title: 'Quest Rewards',
      tooltip: 'Complete the quest rewards to obtain a lot of SMTC, NFTs, or other token rewards.',
      badge: 'none',
      content: '1 reward available',
      buttonName: 'Available',
      url: 'quest',
  ...
  [
    {
      ...
      tooltip: 'As you contribute to Golden Tree, your status as Smart Army is also upgraded with Nobility Titles. King is above everyone!',
      badge: '2',
  ...
  [
    {
      ...
      tooltip: 'Go buy SMT, every 1,000 USD buy transaction accumulated will reward you 1 surprise reward that contains up to 10,000 SMT & 1,000 SMTC!',
      badge: '5',
...
// FOR ACHIEVEMENT
export const achievedTitle = [
  {
    name: 'Prince title achieved!'
  },
  {
    name: 'Elon’s Eye title achieved!'
  },
  {
    name: 'Loyal Army title achieved!'
  },
  {
    name: 'Duke title achieved!'
  },
  {
    name: 'Early Run title achieved!'
  },
  {
    name: 'Earl title achieved!'
  },
  {
    name: 'Sweet Army title achieved!'
  },
  {
    name: 'Viscount title achieved!'
  }
];
